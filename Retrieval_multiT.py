...
from models.distill_model_person_search import ALBEF
...
def train(model, data_loader, optimizer, tokenizer, epoch, warmup_steps, device, scheduler, config):
    ...
    for i, (image1, image2, text1, text2, idx, replace) in enumerate(
        ...
        # loss_cl, loss_pitm, loss_mlm, loss_prd, loss_mrtd, loss_mae, loss_attribute, loss_distill = model(image1, image2, text_input1, text_input2, text_tbpsclip,
        #                                                           alpha=alpha, idx=idx, replace=replace)
        loss = 0.
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', default='./configs/PS_cuhk_pedes_distill.yaml')
    parser.add_argument('--output_dir', default='output/cuhk-pedes_distill')
    ...
    # teacher1: TBPS-CLIP
    # config_path = 'config/config_tbpsclip.yaml'
    # config_tbpsclip = parse_config(config_path)
    main(args, config)

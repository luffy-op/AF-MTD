...
class CLIP(nn.Module):
    ...
    def forward(self, input, alpha):
        ...
        return image_features_norm_gathered, text_features_norm_gathered
        print("image_features_norm_gathered.shape: ", image_features_norm_gathered.shape)
        print("text_features_norm_gathered.shape: ", text_features_norm_gathered.shape)
        import sys
        sys.exit()

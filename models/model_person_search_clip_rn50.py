...
class ALBEF(nn.Module):
    def __init__(self,
        ...
        # 替换视觉编码器为 CLIP 的视觉编码器
        self.visual_encoder = clip_model.visual  # RN50 的视觉编码器

        # 替换文本编码器为 CLIP 的文本编码器
        self.text_encoder = clip_model.transformer  # CLIP 的文本编码器
        self.text_width = clip_model.text_projection.shape[1]  # CLIP 文本编码器的输出维度

...
class ALBEF(nn.Module):
    ...
    def forward(self, image1, image2, text1, text2, alpha, idx, replace):
        ...
        image_embeds = self.visual_encoder(image1) # (bs 197 768)
        ...
        # print('text_output.shape: ', text_output.last_hidden_state.shape) #(32 42 768)
        # import sys
        # sys.exit()
        ...
        # print('text2.input_ids.shape: ', text2.input_ids.shape) # (bs 42)
        # print('text2.attention_mask.shape: ', text2.attention_mask.shape) # (bs 42)
        # print('image_embeds: ', image_embeds.shape) # (bs 197 768)
        # print('image_atts: ', image_atts.shape) # (bs 197)
        # import sys
        # sys.exit()
        ...
        return loss_cl, loss_pitm, loss_mlm
